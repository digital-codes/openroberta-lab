...
Blockly.Msg.BUTTON_LED = "turn button LED on";  // untranslated
...
Blockly.Msg.CIRCLE_LED = "turn circle LED on";  // untranslated
...
Blockly.Msg.FRONT_LEFT = "top left";  // untranslated
Blockly.Msg.FRONT_LEFT_MIDDLE = "top left middle";  // untranslated
Blockly.Msg.FRONT_MIDDLE = "top middle";  // untranslated
Blockly.Msg.FRONT_RIGHT = "top right";  // untranslated
Blockly.Msg.FRONT_RIGHT_MIDDLE = "top right middle";  // untranslated
...
Blockly.Msg.LED_ON_BUTTON_THYMIO_TOOLTIP = "Turns the various button LEDs on with the supplied brightness values. The percentage values range from 0% (off) to 100% (full brightness).";  // untranslated
Blockly.Msg.LED_ON_CIRCLE_THYMIO_TOOLTIP = "Turns the various circle LEDs on with the supplied brightness values. The percentage values range from 0% (off) to 100% (full brightness).";  // untranslated
