...
Blockly.Msg.MOTOROMNI_POSITION_TOOLTIP = "Drive to a specific coordinate given by the odometry data with a specific speed.";  // untranslated
...
Blockly.Msg.SENSOR_DETECTMARK_GETSAMPLE_TOOLTIP_ROBOTINO = "Returns a list IDs (number) of the currently detected marker(s). If no markers are detected, returns an empty list.";  // untranslated
...
Blockly.Msg.SENSOR_MARKERINF_TOOLTIP = "Gibt Zusatzinformationen über den Marker im Kamerabild als Liste zurück. Folgende Werte sind enthalten: [x, y, z].";
