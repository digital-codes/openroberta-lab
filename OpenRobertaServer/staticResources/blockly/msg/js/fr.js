...
Blockly.Msg.AIFES_ADD_RAW_DATA = "add to dataset";  // untranslated
...
Blockly.Msg.AIFES_FNN_LAYERS = "# layers";  // untranslated
Blockly.Msg.AIFES_INIT_RAW_DATA = "initialize dataset";  // untranslated
...
Blockly.Msg.AIFES_LEARNINGFUNCTION = "Learning function";  // untranslated
...
Blockly.Msg.AIFES_NUMBER_HIDDENLAYERS_NEURONS = "# hidden layers";  // untranslated
...
Blockly.Msg.AIFES_NUMBER_OUTPUT_NEURONS = "# output neurons";  // untranslated
...
Blockly.Msg.SENSOR_ACCELEROMETER_VALUE_GETSAMPLE_TOOLTIP = "Lit la valeur en degrés de l'inclinaison ou de la rotation";
