...
Blockly.Msg.SENSOR_DETECTMARK_IDALL_GETSAMPLE_TOOLTIP_ROBOTINO = "Returns a list IDs (number) of the currently detected marker(s). If no markers are detected, returns an empty list.";  // untranslated
