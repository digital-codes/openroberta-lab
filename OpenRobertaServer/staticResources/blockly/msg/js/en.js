...
Blockly.Msg.MOTOROMNI_POSITION_TOOLTIP = "Drive to a specific coordinate given by the odometry data with a specific speed.";
...
Blockly.Msg.SENSOR_DETECTMARK_GETSAMPLE_TOOLTIP_ROBOTINO = "Returns a list IDs (number) of the currently detected marker(s). If no markers are detected, returns an empty list.";
