...
Blockly.Msg.BUTTON_LED = "turn button LED on";
...
Blockly.Msg.CIRCLE_LED = "turn circle LED on";
...
Blockly.Msg.FRONT_LEFT = "top left";
Blockly.Msg.FRONT_LEFT_MIDDLE = "top left middle";
Blockly.Msg.FRONT_MIDDLE = "top middle";
Blockly.Msg.FRONT_RIGHT = "top right";
Blockly.Msg.FRONT_RIGHT_MIDDLE = "top right middle";
...
Blockly.Msg.LED_ON_BUTTON_THYMIO_TOOLTIP = "Turns the various button LEDs on with the supplied brightness values. The percentage values range from 0% (off) to 100% (full brightness).";
Blockly.Msg.LED_ON_CIRCLE_THYMIO_TOOLTIP = "Turns the various circle LEDs on with the supplied brightness values. The percentage values range from 0% (off) to 100% (full brightness).";
